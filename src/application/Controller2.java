...
public class Controller2 {
	...
	public void mic_on() throws LineUnavailableException {
		...
		if (micoin == true && spker != null){
	        ...
	        SourceDataLine speakers = (SourceDataLine) spker.getLine(sourceInfo);
...
//	        int bytesRead;
	        ...
	        Task<Void> audioTask = new Task<>() {
	            ...
	            protected Void call() throws Exception {
	                ...
	                // Loopback audio
	                while (micoin) { // Stop if toggle is switched off
...
//    }
    ...
    public void getofile(File i) {
        ...
        if (lastDotIndex > 0) { // Ensure there is a period (.)
...
//        fileChooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Sound clip", "*.mp3", "*.wav"));
    ...
    public void setthread(Boolean thre,Mixer spk,Thread auThread) throws LineUnavailableException, InterruptedException {
